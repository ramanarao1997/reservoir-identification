...
train_batches = ImageDataGenerator(rescale=1.0/255.0).flow_from_directory('C:/Users/ramana/Desktop/Reservoir Identification/data/train', class_mode='binary', classes=['terrains', 'reservoirs'], batch_size=30, target_size=(224, 224))
validation_batches = ImageDataGenerator(rescale=1.0 / 255.0).flow_from_directory('C:/Users/ramana/Desktop/Reservoir Identification/data/validate', class_mode='binary', classes=['terrains', 'reservoirs'], batch_size=30, target_size=(224, 224))
